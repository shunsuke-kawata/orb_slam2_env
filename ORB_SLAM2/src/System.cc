...
namespace ORB_SLAM2
{
                                            ...
                                            mbDeactivateLocalizationMode(false)
    {
        ...
        // 開始時刻と前回の関数実行時刻を現在時刻に設定を取得
        start_time = chrono::high_resolution_clock::now();
        execution_time = chrono::high_resolution_clock::now();
    ...
    cv::Mat System::TrackMonocular(const cv::Mat &im, const double &timestamp)
    {
        ...
        // 時刻をミリ秒単位に変換
        chrono::time_point<chrono::high_resolution_clock, chrono::milliseconds> now_ms = chrono::time_point_cast<chrono::milliseconds>(now);
        chrono::time_point<chrono::high_resolution_clock, chrono::milliseconds> start_time_ms = chrono::time_point_cast<chrono::milliseconds>(start_time);
        chrono::time_point<chrono::high_resolution_clock, chrono::milliseconds> execution_time_ms = chrono::time_point_cast<chrono::milliseconds>(execution_time);
        // ミリ秒単位の値を取得
        auto value_now = now_ms.time_since_epoch();
        auto value_start_time = start_time_ms.time_since_epoch();
        auto value_execution_time = execution_time_ms.time_since_epoch();
    ...
    void System::SaveKeyFrameTrajectoryTUM(const string &filename)
    {
        ...
        f.close();
        cout << endl
             << "SaveKeyFrameTrajectoryTUM trajectory saved!" << endl;
    }
